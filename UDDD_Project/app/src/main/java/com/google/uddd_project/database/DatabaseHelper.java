        ...
        if (i2 == 2 || i2 == 3) {
            ...
            try {
                ...
                for (int i4 = 1; i4 <= 30; i4++) {
                    int i5 = 0;
                    for (int put : this.mContext.getResources().getIntArray(this.arrCyc[i4 - 1])) {
                        try {
                    ...
                    if (sQLiteDatabase != null) {
                        try {
                            ...
                            sb3.append(i4);
                            sb3.append("'");
                            long update = sQLiteDatabase.update(str2, contentValues, sb3.toString(), null);
