...
public class ReminderEditActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnSaveReminder).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.btnDeleteReminder).setOnClickListener(new View.OnClickListener() {
            @Override
