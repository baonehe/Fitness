...
import com.google.uddd_project.utils.ChartXValueFormatter
...
//            Toast.makeText(this, "Empty", Toast.LENGTH_LONG).show()
        ...
        if (!entries.isEmpty()) {
            ...
            dataSet.fillDrawable = getDrawable(R.drawable.button_green)
            ...
            waterLevelView.setProgress(100-percentage);
