package com.google.uddd_project.helpers
...
import com.google.uddd_project.DailyDrinkTargetActivity
...
class NotificationHelper(val ctx: Context) {
    ...
    private val CHANNEL_ONE_ID = "com.google.uddd_project.CHANNELONE"
    ...
    fun getNotification(
        ...
        val notification = NotificationCompat.Builder(ctx.applicationContext, CHANNEL_ONE_ID)
            ...
            .setLargeIcon(
                BitmapFactory.decodeResource(
                    ctx.resources,
                    R.drawable.water_reminder_icon
                )
            )
        ...
        val notificationIntent = Intent(ctx, DailyDrinkTargetActivity::class.java)
